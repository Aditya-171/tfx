...
class OutputChannel(Channel):
  ...
  def __init__(
      ...
      additional_properties: Optional[Dict[str, Property]] = None,
      additional_custom_properties: Optional[Dict[str, Property]] = None,
      is_intermediate_channel: bool = False,
  ):
    super().__init__(
        type=artifact_type,
    ...
    self._is_intermediate_channel = is_intermediate_channel
  ...
  def __repr__(self) -> str:
    return (
        ...
        f'_is_intermediate_channel={self._is_intermediate_channel}'
    )
  ...
  @property
  @doc_controls.do_not_generate_docs
  def is_intermediate_channel(self) -> bool:
    return self._is_intermediate_channel
  ...
  @doc_controls.do_not_generate_docs
  def set_as_intermediate_channel(self) -> None:
    self._is_intermediate_channel = True
