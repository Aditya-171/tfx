...
class ChannelParameter:
  ...
  def __init__(
    ...
    Args:
      ...
      is_intermediate_channel: Whether the channel parameter is for an
        intermediate artifact or not. Defaults to False.
    """
    ...
    self.type = type
    self.optional = optional
    self.is_intermediate_channel = is_intermediate_channel
